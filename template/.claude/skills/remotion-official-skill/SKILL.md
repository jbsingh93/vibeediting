...
> **JBS Vibe Editing note:** in this project, preview happens in the cockpit Player (`vibe ui`) — Remotion Studio is not part of the product. For quick frame checks use `npx remotion still <CompId> out/check.png --frame=N --scale=0.25`.
